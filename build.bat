...
pyinstaller --onefile --add-data "data/git_installer.exe;." --add-data "data/java_installer.exe;." --add-data "data/jdk_17_installer.exe;." --add-data "data/mmc.zip;." --add-data "data/prominence_icon.png;." --add-data "icon.ico;." main.py --icon=icon.ico --name="Prominence II [Fighter]"
